...
function AgentPulse({size="medium", color="blue"}:AgentPulseProps) {
    ...
    const colorClasses ={
        blue: "bg-blue-500 shadow-[0_0_8px 4px rgba(59,130,246,0.5)]",
        green: "bg-green-500 shadow-[0_0_8px 4px rgba(34,197,94,0.5)]",
        purple: "bg-purple-500 shadow-[0_0_8px 4px rgba(168,85,247,0.5)]"
    }
