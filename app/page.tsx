      ...
      <section className="py-20 bg-gradient-to-b from-white to-purple-50">
        <div className="container mx-auto px-4">
            <div className="flex flex-col items-center gap-10 text-center mb-12">
              ...
              <h1 className=" text-4xl md:text-6xl font-bold text-gray-900 mb-6 ">Meet Your Personal <span className="bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent">AI Content Agent</span></h1>
      ...
      <section className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
             ...
             {features.map((feature,featureIndex)=>{
              ...
              return(
                <div key={featureIndex} className="bg-white p-6 rounded-xl border border-gray-200 hover:border-blue-500 transition-all duration-300">
        ...
        <div className="container mx-auto px-4" >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step,stepIndex)=>{
              ...
              return (
                <div key={stepIndex} className=" text-center p-6 rounded-xl bg-white shadow-md hover:shadow-lg transition-all">
